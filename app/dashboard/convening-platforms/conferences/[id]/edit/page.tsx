...
import { getConference, updateConference, uploadConferenceImage, uploadConferenceResource, type Conference } from "@/services/conferencesService";
...
const EditConferencePage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await updateConference(id, dataToSend);
            alert('Conference updated successfully!');
            router.push(`/dashboard/convening-platforms/conferences/${id}`);
        } catch (error) {
