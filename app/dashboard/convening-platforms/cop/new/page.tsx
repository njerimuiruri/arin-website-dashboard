...
import { createCop, uploadCopImage, uploadCopResource } from "@/services/copService";
...
export default function NewCopPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await createCop(dataToSend);
            alert('COP item created successfully!');
            router.push('/dashboard/convening-platforms/cop');
        } catch (error) {
            console.error('Failed to create COP item:', error);
            alert('Failed to create COP item');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="p-8 max-w-4xl mx-auto">
            ...
            <h1 className="text-3xl font-bold mb-6">Create New COP Item</h1>
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-6 space-y-6">
                ...
                <div className="flex gap-4 pt-4">
                    ...
                    >
                        {loading ? 'Creating...' : 'Create COP Item'}
                    </button>
                    <button
                        type="button"
                        onClick={() => router.back()}
