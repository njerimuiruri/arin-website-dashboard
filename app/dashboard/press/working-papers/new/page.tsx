...
export default function NewWorkingPaperPage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            router.push('/dashboard/press/working-papers');
        } catch (err: any) {
            setError(err.message || 'Failed to create working paper');
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="max-w-5xl mx-auto space-y-8">
                <div className="flex items-center gap-4 animate-in slide-in-from-left duration-500">
                    ...
                    <div>
                        ...
                        <p className="text-slate-600 mt-1">Create a new working paper series entry</p>
                    </div>
                </div>
                {error && (
                        ...
                        <CardHeader className="bg-linear-to-r from-blue-50 to-indigo-50 border-b">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <CardDescription>Enter the core details of your working paper</CardDescription>
                                </div>
                            </div>
                        </CardHeader>
                        ...
                        <CardHeader className="bg-linear-to-r from-indigo-50 to-purple-50 border-b">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <CardDescription>Provide a detailed description with formatting and images</CardDescription>
                                </div>
                            </div>
                        </CardHeader>
                        <CardContent className="space-y-4 pt-6">
